...
async function generateMetadata({ params }) {
    ...
    const project = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$demo$2d$data$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["DEMO_PROJECTS"].find((p)=>p.slug?.current === slug);
    if (!project) return {
...
async function generateStaticParams() {
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$demo$2d$data$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["DEMO_PROJECTS"].map((p)=>({
            slug: p.slug?.current ?? ''
        }));
}
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3a33f6bc._.js.map